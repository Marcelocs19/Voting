...
@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Retorna das pautas", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,schema = @Schema(implementation = ScheduleResponse.class))),
